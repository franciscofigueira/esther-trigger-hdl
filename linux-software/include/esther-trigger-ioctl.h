 ...
 *u_int32_t)
 *
 *#define ATCA_PCIE_IOCS_TMR1CTRL      _IOW(ATCA_PCIE_IOC_MAGIC, 18,
 *u_int32_t)
 *#define ATCA_PCIE_IOCG_TMR1CTRL      _IOR(ATCA_PCIE_IOC_MAGIC, 19,
 *u_int32_t)
 *#define ATCA_PCIE_IOCS_TMR1COUNT     _IOW(ATCA_PCIE_IOC_MAGIC, 20,
 *u_int32_t)
 *#define ATCA_PCIE_IOCG_TMR1COUNT     _IOR(ATCA_PCIE_IOC_MAGIC, 21,
 *u_int32_t)
 *
 *#define ATCA_PCIE_IOCS_TMR2CTRL      _IOW(ATCA_PCIE_IOC_MAGIC, 22,
 *u_int32_t)
 *#define ATCA_PCIE_IOCG_TMR2CTRL      _IOR(ATCA_PCIE_IOC_MAGIC, 23,
 *u_int32_t)
 *#define ATCA_PCIE_IOCS_TMR2COUNT     _IOW(ATCA_PCIE_IOC_MAGIC, 24,
 *u_int32_t)
